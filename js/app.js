(() => {
  ...
  class t {
    ...
    _focusCatch(e) {
      ...
      e.shiftKey && 0 === n && (o[o.length - 1].focus(), e.preventDefault()),
        e.shiftKey || n !== o.length - 1 || (o[0].focus(), e.preventDefault());
    }
    _focusTrap() {
    ...
    (function () {
      ...
      e &&
        e.addEventListener("click", function (e) {
          n && (s(), document.documentElement.classList.toggle("menu-open"));
        });
    })(),
    (function () {
